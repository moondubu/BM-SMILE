      ...
      <div className="StrategyPetPlatform-top">
        <div className="StrategyPetPlatform-inner">
          ...
          <div className="StrategyPetPlatform-topVisual">
            <AppImage src={prefixPath("/images/strategy/img_strategy_petplatform_phones.png")} alt="" aria-hidden="true" />
          </div>
        </div>
      </div>

      <PetPlatformExpansionSection
        className="StrategyPetPlatform-bottom"
        title={"페스룸 프렌즈를 통해\n확장되는 무한한 펫 비즈니스"}
        description={"단순한 앱을 넘어, 사용자 행동과 반려동물 데이터를 축적·연결해\n국내 수직계열화 전략의 핵심 인프라로 확장하고 있습니다."}
        imageSrc="/images/strategy/img_strategy_petplatform_diagram.png"
        imageAlt="페스룸 프렌즈 비즈니스 확장 다이어그램"
        items={[
          {
